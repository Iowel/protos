...
const (
	Auth_Register_FullMethodName = "/auth.local.Auth/Register"
	Auth_Login_FullMethodName    = "/auth.local.Auth/Login"
	Auth_IsAdmin_FullMethodName  = "/auth.local.Auth/IsAdmin"
)
